...
1. Увеличение стоимости проекта
1. Увеличения времени на тестирование проекта 
1. Изменение одного элемента в production версии повлечет за собой падение всех тестов.
